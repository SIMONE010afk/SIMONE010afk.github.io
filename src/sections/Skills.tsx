...
const skills: Skill[] = [
  ...
  { name: 'Rust', icon: Cog, level: 30, category: 'Languages' },
  { name: 'R', icon: Code2, level: 45, category: 'Languages' },
  { name: 'TensorFlow / Keras', icon: Brain, level: 80, category: 'ML/AI' },
  { name: 'PyTorch', icon: Cpu, level: 70, category: 'ML/AI' },
  { name: 'Scikit-learn', icon: Brain, level: 90, category: 'ML/AI' },
  { name: 'XGBoost', icon: Activity, level: 85, category: 'ML/AI' },
  { name: 'NLP', icon: MessageSquare, level: 80, category: 'AI' },
  { name: 'Computer Vision', icon: Eye, level: 75, category: 'AI' },
  { name: 'RAG', icon: Eye, level: 80, category: 'AI' },
  { name: 'Prompt Engineering', icon: MessageSquare, level: 80, category: 'AI' },
  { name: 'Azure AI Foundry', icon: Cloud, level: 80, category: 'AI' },
  { name: 'Azure AI Agent Service', icon: Bot, level: 75, category: 'AI' },
  { name: 'Azure AI Services', icon: Cloud, level: 75, category: 'AI' },
  { name: 'Azure AI Vision', icon: Eye, level: 75, category: 'AI' },
  { name: 'OCR', icon: Eye, level: 75, category: 'AI' },
  { name: 'Power BI', icon: BarChart3, level: 75, category: 'Analytics' },
  { name: 'Feature Engineering', icon: Layers, level: 85, category: 'Data Engineering' },
  ...
  { name: 'Data Governance', icon: Database, level: 60, category: 'Data Engineering' },
  ...
  { name: 'Docker', icon: Terminal, level: 60, category: 'DevOps' },
  { name: 'Linux', icon: Terminal, level: 60, category: 'DevOps' },
  ...
  { name: 'Google Cloud Storage', icon: Cloud, level: 85, category: 'Database' },
